...
import { Activity, ArrowRight, Brain, BrainCircuit, Calendar, Heart, Loader2, MessageSquare, Moon, Sparkles, Sun, Trophy } from "lucide-react";
...
export default function DashboardPage() {
    ...
    // Transform activities into day activity format
                            ...
                            <CardContent className="p-6 relative">
                                <div className="space-y-6">
                                    ...
                                    <div className="grid gap-3">
                                        <Button
                                            variant="default"
                                            className={cn("w-full justify-between items-center p-6 h-auto group/button",
